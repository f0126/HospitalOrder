        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="main.jsp">HOME <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
                <span class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-container">
                        <form data-toggle="validator" data-focus="false" action="/users/login" method="post">
